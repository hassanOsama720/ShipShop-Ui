...
function App() {
  ...
  useEffect(() => {
    let res2 = axios({
      method: "get",
      url: "https://shipshop-api.herokuapp.com/cart",
      headers: {
    ...
    let res5 = axios({
      method: "get",
      url: "https://shipshop-api.herokuapp.com/wishlist",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
      },
    })
    ...
    let res3 = axios({
      method: "get",
      url: `https://shipshop-api.herokuapp.com/orders/customer/${localStorage.getItem(
        "_id"
      )}`,
      headers: {
        Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
